...
const LinkItem = ({ link }) => {
    ...
    export const ImportantLinks = () => {
        ...
        return (
            ...
            <Button className='float-end' color="primary" onClick={toggleModal}><i class="bi bi-plus"></i> Add New</Button>
            <Modal isOpen={modal} toggle={toggleModal}>
            <ModalHeader toggle={toggleModal}>Add Link Details</ModalHeader>
            <ModalBody>
            <Form >
            <FormGroup>
